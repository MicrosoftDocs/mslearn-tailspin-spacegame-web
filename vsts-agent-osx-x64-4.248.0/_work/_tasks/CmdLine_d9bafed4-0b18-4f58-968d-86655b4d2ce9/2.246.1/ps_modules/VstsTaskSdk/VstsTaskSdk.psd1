@{
    ...
    ModuleVersion = '0.20.1' # Do not modify. This value gets replaced at build time with the value from the package.json.
    ...
    PrivateData = @{
        PSData = @{
            ...
            CommitHash = 'ab885244acac2b6da000c01e13bcbcb47eb3e76d' # Do not modify. This value gets replaced at build time.
        }
    }
