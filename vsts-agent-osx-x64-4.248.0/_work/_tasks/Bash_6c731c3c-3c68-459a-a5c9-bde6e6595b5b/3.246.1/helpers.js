...
exports.validateFileArgs = exports.expandBashEnvVariables = void 0;
...
function expandBashEnvVariables(argsLine) {
    const envPrefix = '$';
    const quote = '\'';
...
exports.expandBashEnvVariables = expandBashEnvVariables;
...
function validateFileArgs(inputArguments) {
    ...
    if (featureFlags.activate || featureFlags.audit || featureFlags.telemetry) {
        ...
        const [sanitizedArgs, sanitizerTelemetry] = (0, argsSanitizer_1.sanitizeArgs)(expandedArgs, {
            argsSplitSymbols: '\\\\',
        ...
        if (sanitizedArgs !== inputArguments) {
            if (featureFlags.telemetry && (sanitizerTelemetry || envTelemetry)) {
                const telemetry = {
                    ...envTelemetry !== null && envTelemetry !== void 0 ? envTelemetry : {},
                    ...sanitizerTelemetry !== null && sanitizerTelemetry !== void 0 ? sanitizerTelemetry : {}
                };
                (0, telemetry_1.emitTelemetry)('TaskHub', 'BashV3', telemetry);
            }
