...
async function translateDirectoryPath(bashPath, directoryPath) {
    ...
    try {
        ...
        if (input_targetType.toUpperCase() == 'FILEPATH') {
            ...
            try {
                ...
                (0, telemetry_1.emitTelemetry)('TaskHub', 'BashV3', {
        ...
        // Run bash.
        let exitCode = await bash.exec(options);
