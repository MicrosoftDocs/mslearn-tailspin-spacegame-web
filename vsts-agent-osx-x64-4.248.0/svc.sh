...
SVC_NAME="vsts.agent.SammysOrganisation.Default.Samuels-MacBook-Pro-3"
SVC_DESCRIPTION="Azure Pipelines Agent (SammysOrganisation.Default.Samuels-MacBook-Pro-3)"
